document.addEventListener('DOMContentLoaded', function () {
  ...
  let targetEncoding =
    dlf.saveToLocal.get(targetEncodingCookie) === undefined
      ? defaultEncoding
      : Number(dlf.saveToLocal.get('translate-chn-cht'))
  ...
  function translateBody (fobj) {
    ...
    for (let i = 0; i < objs.length; i++) {
      ...
      if (obj.classList && obj.classList.contains('site-title')) {
        continue
      }
      if (
  ...
  function translatePage () {
    ...
    dlf.saveToLocal.set(targetEncodingCookie, targetEncoding, 2)
    setLang()
    translateBody()
  }
